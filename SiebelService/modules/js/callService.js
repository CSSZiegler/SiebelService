...
function showActivities(status, TimeSheetItems)
{
    if (status == 400)
    {
        ...
        {
        	//#ifdef desktopweb
        		frmActivity.vbxActivityDetail.setVisibility(true);
				frmActivity.lblActivityHeader.setVisibility(true);
        		frmActivity_preshow_Tablet();
        	//#else
        		frmActivity.show();
        	//#endif
       	}
    	...
    	//#ifdef desktopweb
        		frmActivity.btnTimeSheetEntries.setVisibility(true);
        //#else
...
function getActivities(eventobject)
{
	...
	//#ifdef desktopweb
		TimeSheetItems_inputparam["sessionid"] = frmActivity.lblSeesionID.text;
	//#else
...
{	
	//#ifdef desktopweb
		if(frmActivity.lblSeesionID.text == "" || frmActivity.lblSeesionID.text == null )
		{
          alert("Login failed.");
		...
		{	
			frmActivity.lblLoginSuccessConfirm.text = "Login is successful and your session id is :";
			frmActivity.show();
			frmActivity.btnTimeSheetEntries.setVisibility(true);
		}
	//#else
...
function frmLoginSucces_btnTimeSheetEntries() {
    ...
    getActivities();
    //#ifdef desktopweb
    	frmActivity.btnTimeSheetEntries.setVisibility(false);			
    //#else
    	//do nothing
    //#endif
...
function frmLogin_btnLoginSubmission_onClick_response_Tablet(status, login) {
    ...
    if (status == 400) {
    		...
    		{	
    			//#ifdef desktopweb
    				frmActivity.lblSeesionID.text = login.sessionid;
					checkSessiondIDGen();					
    			//#else
